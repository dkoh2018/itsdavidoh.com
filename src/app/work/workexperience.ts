...
export const experiences: WorkExperience[] = [
  ...
  {
    title: "SaaS Sales Development",
    company: "YCharts",
    date: "June 2023 - November 2023 (somewhat transition into tech)",
    description: [
      ...
      "although the long, grueling phone calls weren't my specialty, this role served as a transitional phase after a successful career in finance. andrew (dudes a great man) taught me a great deal about compassion even when capitalism is on the line. he's someone i highly recommend. he significantly contributed to my growth in this field in a short amount of time and despite this valuable experience, my passion for building in the digital realm eventually led me to depaul. it's local and close.",
  ...
  },
  {
    ...
    description: [
      "people really struggled, and i had already built a twitter following right after graduation in 2018. since i was trading independently, i thought, why not post free trades for people to see and grow my reputation. under the handle ironmanoptions (yes, i know, it's quite a name, but the marvel hype was real and who doesn't love tony starks), i experienced a wild ride. ",
  ...
  },
  {
    ...
    description: [
      "i decided to take a break from the corporate world as i already had a profitable strategy in place. times were tough due to disagreements on the direction of the fund we were running, but it was a risk i was willing to take wehn i decided to leave. for 2 years, i grinded like no other in my private office, foregoing an apartment, and managed to work day and night, even on weekends. having the freedom to be self-employed was a great motivator, pushing me to work tirelessly and achieve my goals.",
      "and thank god it worked. was able to afford everything i wanted and finally got to marry the girl of my dreams at 25 years old. young age and grateful",
      "anyway, during my time, i started to learn some python so I developed built some web scraping and etl processes, creating a comprehensive financial metrics database from 10-q and 10-k reports. helpd me achieve a 63% year-over-year roi and im being fair. billion dollar funds doing 30% is insane. not for smaller accounts if you put in the work.",
    ],
  },
  {
    ...
    description: [
      ...
      "my focus was conducting top-down fundamental research using bloomberg terminal was my speciality to identify mispriced assets and derivatives.",
  ...
  },
  {
    ...
    description: [
      ...
      "had the privelage of later working next to the CEO as i simplified his agenda and phoned in international conferences by providing english to korean translation services. this was perhaps my first step into the big world of business",
  ...
  },
  {
    ...
    description: [
      ...
      "received fantastic feedback from 1000's of students, organizing events ranging from formals and sorority/fraternity parties to mixers and gatherings but not mention that we had a ton of fun as well ;)",
    ],
  },
  {
